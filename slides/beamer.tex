...
\addplot+[load] table[x={time[s]},y=cpu0.load] {../data/browser-email-80-0-80.csv};
\addplot+[load] table[x={time[s]},y=cpu1.load] {../data/browser-email-80-0-80.csv};
\addplot+[load] table[x={time[s]},y=cpu2.load] {../data/browser-email-80-0-80.csv};
\addplot+[load] table[x={time[s]},y=cpu3.load] {../data/browser-email-80-0-80.csv};
